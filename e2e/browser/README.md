# End-to-end tests for etl-tutorial in the browser
...
One thing to note is that its dependency on etl-tutorial is on the code _inside
...
actually call out to etl-tutorial, i.e. that are run in the actual test. The
